...
| 内容 | 状态 | 说明 |
|---|---|---|
| Milestone 0 公共实验基础设施 | 已完成 | 实现、回归和验收已完成，见 `milestone0_summary.md` |
| 本轮 M1 优化与科研决策整理 | 已关闭 | 仅表示本轮规则审核和决策确认结束，见 `m1_optimization_closure.md` |
...
- `research_decision_register.md`：科研语义决定及其状态；
- `online_offline_experiment_execution_contract.md`：Milestone 0 实施与语义保护契约；
- `milestone0_summary.md`：Milestone 0 已完成内容和后续进入条件；
- `m1_optimization_closure.md`：本轮 M1 优化关闭边界。
